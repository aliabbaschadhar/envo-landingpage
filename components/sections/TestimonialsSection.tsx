            ...
            <div className="w-full max-w-4xl relative">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="glass-panel rounded-3xl p-8 md:p-12 border border-white/10 glow-blue"
                >
                  {/* Quote Icon */}
                  <motion.div
                    initial={{ scale: 0 }}
                    ...
                    className="w-12 h-12 rounded-full bg-gradient-to-br from-electric-blue to-electric-purple p-3 mb-8 mx-auto md:mx-0"
                  >
                  ...
                  <div className="grid md:grid-cols-[1fr_auto] gap-8 items-center">
                    ...
                    <div className="text-center md:text-left">
                      ...
                      <div className="flex justify-center md:justify-start space-x-1 mb-6">
                        {Array.from({ length: testimonials[currentIndex].rating }).map((_, i) => (
                          ...
                          >
                            <Star className="w-5 h-5 fill-electric-green text-electric-green" />
                          </motion.div>
                        ))}
                      </div>
                      ...
                      {/* Author */}
                      <div>
                        <div className="font-semibold text-white text-lg font-geist">
                    ...
                    >
                      <div className="w-24 h-24 rounded-2xl overflow-hidden ring-2 ring-electric-blue/20 mx-auto">
                        <img
          ...
          <div className="flex justify-center items-center space-x-6 mt-12">
            ...
            >
              <Button
                ...
                className="glass-panel border-white/20 hover:border-electric-blue/50 text-white hover:text-electric-blue w-12 h-12 rounded-xl transition-all duration-300"
              >
              ...
              {testimonials.map((_, index) => (
                <motion.button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 ${
                    index === currentIndex 
                      ? 'bg-electric-blue w-8 glow-blue' 
